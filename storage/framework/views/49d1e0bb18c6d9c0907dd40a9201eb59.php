                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
                                ...
                                <div class="button">
                                    <a href="<?php echo e(route('lomba.index')); ?>" class="btn">Daftar Sekarang</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\DutaPemudaFinal-main\resources\views/landing-page.blade.php ENDPATH**/ ?>